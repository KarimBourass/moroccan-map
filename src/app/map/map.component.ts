  ...
  ngOnInit(): void {
    ...
    map.on('load', () => {
      const hiddenIdsMapping = {
        '6': [
          888, 887, 886, 885, 311, 312, 313, 314, 315, 316, 317, 318, 220, 298,
          292, 297, 286, 277, 288, 310, 293, 296, 287, 289, 294, 308, 290, 834,
          855, 835, 827, 820, 854, 830, 832, 786, 857, 805, 773, 821, 822, 448,
          638, 447, 828, 208, 307, 306,
        ],
        '6.6': [
          646, 647, 648, 649, 248, 249, 251, 244, 245, 246, 247, 250, 242, 191,
          237, 241, 243, 240, 8, 183, 3, 6, 10, 1, 14, 16, 9, 11, 15, 18, 12,
          95, 104, 77, 96, 88, 82, 103, 91, 89, 12, 92, 83, 93, 72, 106, 76, 84,
          42, 45, 41, 71,
        ],
        '7.61': [
          225, 226, 227, 228, 74, 75, 77, 70, 71, 72, 73, 76, 68, 69, 56, 64,
          56, 67, 5, 57, 66, 54, 2, 4, 7, 16, 11, 13, 6, 8, 12, 15, 9, 13, 16,
          4, 14, 7, 5,
        ],
        '8.61': [
          44, 16, 17, 18, 19, 10, 11, 12, 9, 19, 20, 21, 1, 21, 22, 25, 18, 17,
          10, 13, 16, 15, 3, 2, 4, 1, 3, 6, 10, 7, 8, 7, 5,
        ],
      ...
      function applyHiddenStates() {
        ...
        const hiddenIds =
          hiddenIdsMapping[key as keyof typeof hiddenIdsMapping];
